...
{
  public class AppointmentsManagement : RhoModule
  {
    ...
    int putUnder = 2;
    String myName = "Visits and Appointments";
    string myDesc = "This module helps you to manage your organization's Client Visits and Appointments Scheduling!";
    string audit_tbl_name = "hosp.hosp_audit_trail_tbl";
    WeifenLuo.WinFormsUI.Docking.DockContent myMainInterface = new mainForm();
    String vwroleName = "View Visits and Appointments";
    Int64 usr_id = -1;
