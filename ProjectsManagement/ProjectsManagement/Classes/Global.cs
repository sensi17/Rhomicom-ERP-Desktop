...
namespace ProjectsManagement.Classes
{
  /// <summary>
  ...
  class Global
  {
    ...
    public static ProjectsManagement myProj = new ProjectsManagement();
    public static mainForm mnFrm = null;
    public static wfnProjectsForm wfnProjsFrm = null;
    public static wfnProjsSearchForm wfnProjsSrchFrm = null;
    public static wfnProjsSearchForm wfnProjsSrchDiag = null;
    public static wfnResourcesForm wfnResourceFrm = null;
    public static wfnAccntSetupForm wfnAccntSetupFrm = null;
...
" OFFSET " + (Math.Abs(offset * limit_size)).ToString();
      ...
      Global.wfnProjsFrm.rec_SQL = strSql;
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      return dtst;
    }
...
"WHERE ((a.org_id = " + orgID + ")" + whrcls + extrWhr + ")";
  ...
  FROM proj.proj_team_members a " +
      ...
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      Global.wfnProjsFrm.rec_det_SQL = strSql;
      return dtst;
    }
 ...
 a.comments_remarks, a.proj_task_clsfctn, a.is_completed  
  FROM proj.project_task_assgnmnts a " +
      ...
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      Global.wfnProjsFrm.rec_tasks_SQL = strSql;
      return dtst;
    }
 ...
 a.comments_remarks, a.supplier_id, scm.get_cstmr_splr_name(a.supplier_id)   
  FROM proj.project_rsrc_alloctns a " +
      ...
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      Global.wfnProjsFrm.rec_rsrc_SQL = strSql;
      return dtst;
    }
...
" OFFSET " + (Math.Abs(offset * limit_size)).ToString();
      ...
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      Global.wfnProjsSrchFrm.rec_SQL = strSql;
      return dtst;
    }
...
and ('Visit'=y.other_mdls_doc_type or y.other_mdls_doc_type IS NULL)) " +
   ...
   @" and (y.invc_hdr_id>0 or y.invc_hdr_id IS NULL)" + extrWhere;
    ...
    public static DataSet get_One_VisitDt(long vstID)
    {
      ...
      y.invc_type, COALESCE(y.enbl_auto_misc_chrges,'0'), a.cstmr_site_id
          FROM hosp.visit a 
   ...
   @" ";
    ...
    @" ORDER BY a.appntmnt_date ASC";
      ...
      if (Global.wfnProjsFrm != null)
      {
        //Global.wfnProjsFrm.fclty_SQL = strSql;
      }
   ...
   System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
      ...
      string apprvlSts)
    {
      ...
      string updtSQL = "UPDATE hosp.appntmnt SET " +
            "appntmnt_status='" + apprvlSts + "', last_update_by=" + Global.myProj.user_id +
            ", last_update_date='" + dateStr +
            "' WHERE (appntmnt_id = " +
            docid + ")";
      Global.mnFrm.cmCde.updateDataNoParams(updtSQL);
       ...
       string apprvlSts)
    {
      ...
      string updtSQL = "UPDATE hosp.visit SET " +
            "vst_status='" + apprvlSts + "', last_update_by=" + Global.myProj.user_id +
            ", last_update_date='" + dateStr +
            "' WHERE (vst_id = " +
            docid + ")";
      Global.mnFrm.cmCde.updateDataNoParams(updtSQL);
...
a.selling_price, a.tax_code_id, CASE WHEN scm.get_cstmr_splr_dscntid("
  ...
  Int64 offset, int limit_size, int orgID)
   ...
   " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
      ...
      Global.wfnAccntSetupFrm.rec_SQL = strSql;
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      return dtst;
    }
...
price_less_tx, is_enabled, selling_price
  ...
  Int64 offset, int limit_size)
   ...
   " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
      ...
      Global.wfnAccntSetupFrm.recDt_SQL = strSql;
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      return dtst;
    }
...
ELSE scm.get_cstmr_splr_name(d.cstmr_id) END 
   ...
   " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
      if (Global.wfnProjsSrchFrm != null)
      {
        Global.wfnProjsSrchFrm.rec_SQL = strSql;
      }
      if (Global.wfnProjsSrchDiag != null)
      {
        Global.wfnProjsSrchDiag.rec_SQL = strSql;
      }
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      return dtst;
    }
...
ON (a.srvc_data_capture_id = b.srvc_data_capture_id and b.appntmnt_id = " + appntmntID +
   ...
   " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
      ...
      if (Global.wfnProjsSrchFrm != null)
      {
        Global.wfnProjsSrchFrm.recDt_SQL = strSql;
      }
      if (Global.wfnProjsSrchDiag != null)
      {
        Global.wfnProjsSrchDiag.recDt_SQL = strSql;
      }
...
Main Service Offered*/
   ...
   " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
      ...
      Global.wfnResourceFrm.rec_SQL = strSql;
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      return dtst;
    }
...
comments_rmrks, max_daily_appntmnts, cur_days_appntmnts  
  FROM hosp.srvs_prvdrs a " +
   ...
   " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
      ...
      Global.wfnResourceFrm.recDt_SQL = strSql;
      DataSet dtst = Global.mnFrm.cmCde.selectDataNoParams(strSql);
      return dtst;
    }
...
, SUM(a.dbt_amount) dbt_sum, " +
   ...
   Int64 offset, int limit_size, long hdrID, ref string attchSQL)
    ...
    public static void refreshRqrdVrbls()
    {
      ...
      Global.mnFrm.cmCde.SampleRole = "Projects Management Administrator";
