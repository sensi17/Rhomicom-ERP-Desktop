...
{
  public class ProjectsManagement : RhoModule
  {
    ...
    int putUnder = 2;
    String myName = "Projects Management";
    string myDesc = "This module helps you to manage your organization's Projects and their Associated Costs!";
    string audit_tbl_name = "proj.proj_audit_trail_tbl";
    WeifenLuo.WinFormsUI.Docking.DockContent myMainInterface = new mainForm();
    String vwroleName = "View Projects Management";
    Int64 usr_id = -1;
