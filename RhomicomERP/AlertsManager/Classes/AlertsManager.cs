...
namespace AlertsManager.Classes
{
  public class AlertsManager
  {
    public AlertsManager()
		...
		int putUnder = 1;
    String myName = "Alerts Manager";
    string myDesc = "This module helps you to manage your organization's Alerts!";
    string audit_tbl_name = "alrt.alrt_audit_trail_tbl";
		//WeifenLuo.WinFormsUI.Docking.DockContent myMainInterface = new mainForm();
    String vwroleName = "View Alerts Manager";
		Int64 usr_id = -1;
