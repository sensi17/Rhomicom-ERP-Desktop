namespace Accounting.Dialogs
{
  partial class attchmntsDiag
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.attchmntsListView.KeyDown += new System.Windows.Forms.KeyEventHandler(this.attchmntsListView_KeyDown);
      // 
      // columnHeader8
      // 
      ...
      // openFileButton
      // 
      this.openFileButton.Image = global::Accounting.Properties.Resources.mi_scare_report;
      ...
      this.prvwPictureBox.Image = global::Accounting.Properties.Resources.actions_document_preview;
      ...
      this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.attchmntsDiag_KeyDown);
