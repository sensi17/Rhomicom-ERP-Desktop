namespace CommonCode
	{
	partial class gnrtRptProgressDiag
		{
		/// <summary>
        ...
        this.progressLabel.Text = "Generating Report... Please Wait...";
        ...
        this.Name = "gnrtRptProgressDiag";
        this.ShowInTaskbar = false;
        this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
        this.Text = "Generating Report...";
        this.Load += new System.EventHandler(this.gnrtRptProgressDiag_Load);
