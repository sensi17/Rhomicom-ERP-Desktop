...
namespace GeneralSetup.Classes
	{
	public class GeneralSetup //: RhoModule
		{
		public GeneralSetup()
			{
			}
    ...
    //WeifenLuo.WinFormsUI.Docking.DockContent myMainInterface = new mainForm();
		String vwroleName = "View General Setup";
		Int64 usr_id = -1;
    ...
    //  }
		...
		public void loadMyRolesNMsgtyps()
			...
			Global.myNwMainFrm.cmmnCodeGstp.checkNAssignReqrmnts();
			}
