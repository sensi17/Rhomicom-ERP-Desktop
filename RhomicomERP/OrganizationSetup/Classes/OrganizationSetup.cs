...
namespace OrganizationSetup.Classes
	{
	public class OrganizationSetup //: RhoModule
		{
    ...
    //WeifenLuo.WinFormsUI.Docking.DockContent myMainInterface = new mainForm();
		String vwroleName = "View Organization Setup";
		Int64 usr_id = -1;
    ...
    //  }
		...
		public void creatWordReport()
			{
   Global.mnFrm.cmCde.exprtToWordOrg(int.Parse(Global.mnFrm.orgIDTextBox.Text));
		//	MessageBox.Show("Not yet implemented!");
			}
