...
namespace InternalPayments.Classes
{
    ...
    class Global3
    {
      ...
      /*103*/"Can Edit Unit Price"};
        ...
        {
            string dateStr = Global3.mnFrm.cmCde1.getDB_Date_time();
            string insSQL = "INSERT INTO scm.scm_dflt_accnts(" +
                  ...
                  orgid + ", " + Global3.myInv.user_id + ", '" + dateStr +
                  "', " + Global3.myInv.user_id + ", '" + dateStr +
                  "',-1)";
            Global3.mnFrm.cmCde1.insertDataNoParams(insSQL);
        }
          ...
          long reqID, int prntdInvCur, decimal exchRate, string pyTrms)
        {
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd");
            ...
            string insSQL = "INSERT INTO scm.scm_prchs_docs_hdr(" +
                  ...
                  "', '" + apprvlSts.Replace("'", "''") + "', " + Global3.myInv.user_id + ", '" + dateStr +
                  "', " + Global3.myInv.user_id + ", '" + dateStr +
                  "', '" + nxtApprvl.Replace("'", "''") +
                  "', '" + docNum.Replace("'", "''") + "', '" +
          ...
          double qty, double untPrice, int storeID, int crncyID, long srclnID, string altrntNm)
        {
            ...
            string insSQL = "INSERT INTO scm.scm_prchs_docs_det(" +
                  ...
                  "VALUES (" + docID +
                  ", " + itmID +
                  ", " + qty + ", " + untPrice + ", " + Global3.myInv.user_id + ", '" + dateStr +
                  "', " + Global3.myInv.user_id + ", '" + dateStr +
                  "', " + storeID +
...
GROUP BY customer_id,invc_curr_id";
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(selSQL);
          ...
          long srcDocHdrID, bool autoCalc)
        {
            ...
            string insSQL = "INSERT INTO scm.scm_doc_amnt_smmrys(" +
                  ...
                  "', " + srcDocHdrID + ", " + Global3.myInv.user_id + ", '" + dateStr +
                  "', " + Global3.myInv.user_id + ", '" + dateStr + "', '" +
                  Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(autoCalc) + "')";
            Global3.mnFrm.cmCde1.insertDataNoParams(insSQL);
        }
         ...
         long event_rgstr_id, string evntCtgry, bool allwDues, string evntType)
        {
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd");
            ...
            string insSQL = "INSERT INTO scm.scm_sales_invc_hdr(" +
                  ...
                  "','" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(enblAutoChrg) +
                  "'," + event_rgstr_id + ", '" + evntCtgry.Replace("'", "''") +
                  "','" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(allwDues) +
                  "', '" + evntType.Replace("'", "''") +
                  "')";
            Global3.mnFrm.cmCde1.insertDataNoParams(insSQL);
        }
      ...
      rtrn_reason, consgmnt_ids, orgnl_selling_price,is_itm_delivered, lnkd_person_id,alternate_item_name) " +
                  ...
                  ",'" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(dlvrd) + "', " + prsnID +
                  ",'" + altrntNm.Replace("'", "''") + "')";
            Global3.mnFrm.cmCde1.insertDataNoParams(insSQL);
        }
         ...
         double rsvdQty, double avlblQty, string balsDate)
        {
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
            ...
            string insSQL = "INSERT INTO inv.inv_stock_daily_bals(" +
              ...
              "VALUES (" + skckId +
              ", " + totQty + ", " + rsvdQty + ", " + avlblQty + ", '" + balsDate + "', " + Global3.myInv.user_id + ", '" + dateStr +
                              "', " + Global3.myInv.user_id + ", '" + dateStr + "', ',')";
            Global3.mnFrm.cmCde1.insertDataNoParams(insSQL);
        }
          ...
          string payRmrk, string srcDocTyp, long srcDocID, string dateStr, string dateRcvd)
        {
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
            string insSQL = "INSERT INTO scm.scm_payments(" +
             ...
             "', " + srcDocID + ", " + Global3.myInv.user_id + ", '" + dateStr + "', " +
                     Global3.myInv.user_id + ", '" + dateStr + "', '" + dateRcvd + "')";
            Global3.mnFrm.cmCde1.insertDataNoParams(insSQL);
        }
        ...
        string batchdesc, string batchsource)
        {
            ...
            string insSQL = "INSERT INTO accb.accb_trnsctn_batches(" +
             ...
             "', " + Global3.myInv.user_id + ", '" + dateStr + "', " + orgid + ", '0', " +
                     Global3.myInv.user_id + ", '" + dateStr + "', '" +
        ...
        {
            string dateStr = Global3.mnFrm.cmCde1.getDB_Date_time();
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "";
            string insSQL = "UPDATE accb.accb_trnsctn_batches SET avlbl_for_postng='" + avlblty +
              "', last_update_by=" + Global3.myInv.user_id +
              ", last_update_date='" + dateStr +
              "' WHERE batch_id = " + batchid;
            Global3.mnFrm.cmCde1.updateDataNoParams(insSQL);
        }
        public static double get_Batch_DbtSum(long batchID)
        {
          ...
          "WHERE(a.batch_id = " + batchID + ")";
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            if (dtst.Tables[0].Rows.Count > 0)
            {
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Batch Name = " + batchNm;
            string delSql = "DELETE FROM accb.accb_trnsctn_batches WHERE(batch_id = " + batchid + ")";
            Global3.mnFrm.cmCde1.deleteDataNoParams(delSql);
        }
      ...
      double dbtAmnt, string trnsDate, int crncyid,
          ...
          double funcExchRate, double acntExchRate, string dbtOrCrdt)
        {
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
            ...
            func_cur_exchng_rate, accnt_cur_exchng_rate, dbt_or_crdt) " +
                              ...
                              ", '" + trnsDate + "', " + crncyid + ", " + Global3.myInv.user_id + ", '" + dateStr +
                              "', " + batchid + ", " + crdtamnt + ", " + Global3.myInv.user_id +
        ...
        public static void updtBatchTrnsSrcIDs(long batchID)
        {
            ...
            Global3.mnFrm.cmCde1.updateDataNoParams(updtSQL);
        }
        ...
        {
            string accntType = Global3.mnFrm.cmCde1.getAccntType(accntid);
            string isContra = Global3.mnFrm.cmCde1.isAccntContra(accntid);
            if (isContra == "0")
            {
         ...
         string batchdesc, string btchsrc, string batchvldty, long srcbatchid, string avlblforPpstng)
        {
            ...
            "batch_source, batch_vldty_status, src_batch_id, avlbl_for_postng) " +
                              ...
                              "', " + Global3.myInv.user_id + ", '" + dateStr +
                              "', " + orgid + ", '0', " + Global3.myInv.user_id + ", '" + dateStr +
                              "', '" + btchsrc.Replace("'", "''") +
                              "', '" + batchvldty.Replace("'", "''") +
                              "', " + srcbatchid +
                              ",'" + avlblforPpstng + "')";
        ...
        {
            int fnccurid = Global3.mnFrm.cmCde1.getOrgFuncCurID(Global3.mnFrm.cmCde1.Org_id);
            //this.curCode = Global3.mnFrm.cmCde1.getPssblValNm(this.curid);
      ...
      FROM accb.accb_exchange_rates a WHERE ((a.currency_from_id=" + fromCurrID +
            ...
            {
                double a = Global3.get_LtstExchRate(fromCurrID, fnccurid, asAtDte);
                double b = Global3.get_LtstExchRate(toCurrID, fnccurid, asAtDte);
                if (a != 0 && b != 0)
                {
                    return a / b;
                }
          ...
          double funcExchRate, double acntExchRate, string dbtOrCrdt)
        {
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
            ...
            func_cur_exchng_rate, accnt_cur_exchng_rate, dbt_or_crdt) " +
                     "VALUES (" + accntid + ", '" + trnsdesc.Replace("'", "''") + "', " + dbtamnt +
                     ", '" + trnsdte.Replace("'", "''") + "', " + crncyid + ", " + Global3.myInv.user_id +
                     ", '" + dateStr + "', " + batchid + ", " + crdtamnt + ", " +
                     Global3.myInv.user_id + ", '" + dateStr + "', " + netamnt +
                     ", '0', '" + srcids + "', " + entrdAmt +
                              ", " + entrdCurrID + ", " + acntAmnt +
                              ", " + acntCurrID + ", " + funcExchRate +
                              ", " + acntExchRate + ", '" + dbtOrCrdt + "')";
...
age(now(),to_timestamp(a.last_update_date,'YYYY-MM-DD HH24:MI:SS')) > interval '5 minute') 
    ...
    ORDER BY 1;";
            /**/
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.mnFrm.trnsDet_SQL = strSql;
            return dtst;
        }
      ...
      long srcDocID, long srcDocLnID, string dateStr, string trnsSrc)
            ...
            string act_typ, string src_trnsID)
        {
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
            ...
            "SET last_update_by = " + Global3.myInv.user_id +
            ", last_update_date = '" + dateStr +
       ...
       System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
          ...
          string apprvlSts, string nxtApprvl)
        {
            ...
            string updtSQL = "UPDATE scm.scm_sales_invc_hdr SET " +
                  "approval_status='" + apprvlSts + "', last_update_by=" + Global3.myInv.user_id +
                  ", last_update_date='" + dateStr +
          ...
          bool dlvrd, long prsnID, string altrntNm)
        {
            ...
            string updtSQL = "UPDATE scm.scm_sales_invc_det SET " +
                  ...
                  "', is_itm_delivered ='" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(dlvrd) +
        ...
        //         "', approval_status='" + apprvlSts.Replace("'", "''") + "', last_update_by=" + Global3.myInv.user_id +
        //         ", last_update_date='" + dateStr +
        //         "', next_aproval_action='" + nxtApprvl.Replace("'", "''") +
        ...
        //         ", enbl_auto_misc_chrges='" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(enblAutoChrg) + "' " +
        //         "WHERE (invc_hdr_id = " +
        //         docid + ")";
        //   Global3.mnFrm.cmCde1.updateDataNoParams(updtSQL);
        // }
          ...
          bool allwDues, string evntType)
        {
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd");
            ...
            string updtSQL = "UPDATE scm.scm_sales_invc_hdr SET " +
                  ...
                  ", allow_dues = '" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(allwDues) +
          ...
          double amnt, bool autoCalc, string smmryNm)
        {
            ...
            string updtSQL = "UPDATE scm.scm_doc_amnt_smmrys SET " +
                  "smmry_amnt = " + amnt +
                  ", last_update_by = " + Global3.myInv.user_id + ", " +
                  "auto_calc = '" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(autoCalc) +
                  "', last_update_date = '" + dateStr +
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Deleting a Sales Document and all its Lines";
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Deleting a Process Definition and all its Lines";
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Deleting a Process Run and all its Lines";
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Deleting a Purchase Document and all its Lines";
...
or scm.get_src_doc_num(src_doc_id, src_doc_typ)=''";
        ...
        public static string getItmUOM(string parItmCode)
        {
            string qryItmUOM = "SELECT uom_name FROM inv.unit_of_measure WHERE uom_id = " +
                ...
                + "' AND org_id = " + Global3.mnFrm.cmCde1.Org_id + ")";

            DataSet ds = new DataSet();
            ds.Reset();
            ds = Global3.fillDataSetFxn(qryItmUOM);
       ...
       contraindications, food_interactions " +
        ...
        public static string getOldstItmCnsgmts(long itmID, double qnty)
        {
            ...
            string strSql = "SELECT distinct c.consgmt_id, inv.get_csgmt_lst_avlbl_bls(c.consgmt_id) " +
              ...
              "WHERE ((c.itm_id=" + itmID + ") and (c.subinv_id =" + Global3.selectedStoreID + ") and  (inv.get_csgmt_lst_avlbl_bls(c.consgmt_id)>0)) ORDER BY c.consgmt_id ASC";
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Clear Balance History";
...
from inv.inv_stock_daily_bals c where c.stock_id = tbl2.stock_id)
    ORDER BY 9,11;";
        ...
        public static void delInvalidBals()
        {
            ...
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Auto Correct Latest Stock/Balances Using Consignment Balances";
            string delSQL = @"
...
";
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Clearing GL-Inventory Interface Values";
...
";
      ...
      WHERE (selling_price = 0 and price_less_tax =0)";
            ...
            long parLineID, int parCurncyID)
        {
            ...
            //            Global3.mnFrm.cmCde1.getDB_Date_time(), "yyyy-MM-dd HH:mm:ss",
            ...
            //    catch (Exception ex)
            //    {
            //        Global3.mnFrm.cmCde1.showMsg(ex.Message, 0);
            //        return false;
            //    }
            return false;
        }
        ...
        //        //dateStr = Global3.mnFrm.cmCde1.getDB_Date_time();
        //        string dateStr = DateTime.ParseExact(
        //            Global3.mnFrm.cmCde1.getDB_Date_time(), "yyyy-MM-dd HH:mm:ss",
        //            System.Globalization.CultureInfo.InvariantCulture).ToString("dd-MMM-yyyy HH:mm:ss");
        ...
        ////          Global3.createScmPyblsDocDet(parDocID, "1Initial Amount",
        ...
        public static int getStoreID(string parStore)
        {
            ...
            DataSet ds = new DataSet();
            ds.Reset();
            ds = Global3.fillDataSetFxn(qryGetStoreID);
        ...
        public static List<string[]> getItmCnsgmtVals(long itmID)
        {
            ...
            string strSql = "SELECT distinct c.consgmt_id, inv.get_csgmt_lst_tot_bls(c.consgmt_id), c.cost_price " +
              "FROM inv.inv_consgmt_rcpt_det c " +
              "WHERE ((c.itm_id=" + itmID + ") and (c.subinv_id =" + Global3.selectedStoreID + ")) ORDER BY c.consgmt_id ASC";
        ...
        {
            List<string[]> res = new List<string[]>();
            List<string[]> oldres = Global3.getCsgmtsDist(srcDocLnID, cnsgmtIDs);
            double remQty = qnty;
            for (int i = oldres.Count - 1; i >= 0; i--)
            {
                ...
                string[] rec = new string[3];
                //Global3.mnFrm.cmCde1.showMsg(ary[0] + ary[1] + ary[2], 0);
                if (crQty <= remQty)
                {
            ...
            if (dtst.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ary1.Length; i++)
                {
                    ...
                    try
                    {
                        rec[0] = ary1[i];
                        rec[1] = ary[i];
                        rec[2] = Global3.mnFrm.cmCde1.getGnrlRecNm("inv.inv_consgmt_rcpt_det", "consgmt_id", "cost_price", long.Parse(ary1[i]));
                        res.Add(rec);
                    }
                    catch (Exception ex)
                    {
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Attachment Name = " + attchNm;
       ...
       Int64 offset, int limit_size, long hdrID, ref string attchSQL)
        ...
        {
            string codeSQL = Global3.mnFrm.cmCde1.getGnrlRecNm("scm.scm_tax_codes",
              "code_id", "sql_formular", codeID);
            codeSQL = codeSQL.Replace("{:qty}", qnty.ToString()).Replace("{:unit_price}", unitAmnt.ToString());
            if (codeSQL != "")
            {
                DataSet d1 = Global3.mnFrm.cmCde1.selectDataNoParams(codeSQL);
                double rs1 = 0;
...
and a.is_enabled='1' ORDER BY a.pssbl_value_id LIMIT 1 OFFSET 0";
      ...
      CASE WHEN a.alternate_item_name='' THEN b.item_desc ELSE a.alternate_item_name END, d.cat_name " +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            Global3.invcFrm.recDt_SQL = strSql;
            return dtst;
        }
...
ORDER BY " + ordrBy + @"";
      ...
      to_char(to_timestamp(a.invc_date,'YYYY-MM-DD'),'DD-Mon-YYYY'), " +
        ...
        public static DataSet get_Basic_SalesDoc(
         string searchWord, string searchIn,
      Int64 offset, int limit_size, int orgID, bool onlySelf, bool shwUnpstdOnly, long inputCstmrID)
        {
            string strSql = "";
            string whereClause = "";
            string crtdByClause = "";
...
and round(f.smmry_amnt,2)>0 and a.invc_hdr_id=f.src_doc_hdr_id and f.src_doc_type=a.invc_type)";
            ...
            if (onlySelf == true)
            {
                crtdByClause = " AND (created_by=" + Global3.mnFrm.cmCde1.User_id + ")";
            }
            if (inputCstmrID > 0)
            {
                crtdByClause = " AND (a.customer_id=" + inputCstmrID + ")";
            }
         ...
         " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
            ...
            Global3.invcFrm.rec_SQL = strSql;
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            return dtst;
        }
       ...
       Int64 offset, int limit_size, long hdrID, ref string attchSQL)
        ...
        public static int getUserStoreID()
        {
            string strSql = "select y.subinv_id " +
              ...
              "y.allow_sales = '1' and z.user_id = " + Global3.myInv.user_id +
              " and y.org_id= " + Global3.mnFrm.cmCde1.Org_id + " order by 1 LIMIT 1 OFFSET 0 ";
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            if (dtst.Tables[0].Rows.Count > 0)
            {
        ...
        public static DataSet get_DocSmryLns(long dochdrID, string docTyp)
        {
            ...
            if (Global3.invcFrm != null)
            {
                Global3.invcFrm.smmry_SQL = strSql;
            }
            return dtst;
        }
        ...
        public static DataSet get_One_CnsgnmntLines(long dochdrID)
        {
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.pOdrFrm.recDt_SQL = strSql;
            return dtst;
        }
      ...
      Int64 offset, int limit_size, int orgID, bool onlySelf)
        {
         ...
         " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
            ...
            //Global3.pOdrFrm.rec_SQL = strSql;
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            return dtst;
        }
...
WHERE a.gl_batch_id = -1 and a.accnt_id = b.accnt_id and b.org_id=" + orgID +
        ...
        public static bool isThereANActvActnPrcss(string prcsIDs, string prcsIntrvl)
        {
            ...
            //Global3.mnFrm.cmCde1.showMsg(strSql, 0);
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            if (dtst.Tables[0].Rows.Count > 0)
            {
...
to_char(to_timestamp(a.trnsctn_date,'YYYY-MM-DD HH24:MI:SS'),'DD-Mon-YYYY HH24:MI:SS'), a.dbt_amount, " +
         ...
         " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.glFrm.vwInfcSQLStmnt = strSql;
            return dtst;
        }
...
or scm.get_src_doc_num(v.src_doc_id,v.src_doc_typ)=''))";
      ...
      sec.get_usr_name(a.created_by), gl_batch_id, accb.get_gl_batch_name(gl_batch_id), b.pymnt_batch_name, a.pymnt_batch_id " +
             ...
             "ORDER BY a.pymnt_id DESC LIMIT " + limit_size +
               " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.mnFrm.pymntsGvn_SQL = strSql;
            return dtst;
        }
...
WHERE a.item_code_name = '" + ItemName.Replace("'", "''") + "' AND a.org_id = " + Global3.mnFrm.cmCde1.Org_id + @"";
     ...
     tbl1.item_id, pay.get_first_itmval_id(tbl1.item_id), 
      ...
      inv.get_uom_name(c.base_uom_id), c.item_type " +
        ...
        {
            string itmSQL = Global3.mnFrm.cmCde1.getGnrlRecNm("pay.pay_itm_sets_hdr",
     ...
     tbl1.item_id, pay.get_first_itmval_id(tbl1.item_id), 
      ...
      inv.get_uom_name(c.base_uom_id), c.item_type " +
          ...
          "ORDER BY b.pay_run_priority ";
            ...
            //Global3.mnFrm.cmCde1.showSQLNoPermsn(strSql);
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.mnFrm.idet_SQL = strSql;
            return dtst;
        }
...
b.item_min_type, b.inv_item_id, inv.get_invitm_name(b.inv_item_id), 
      ...
      inv.get_uom_name(d.base_uom_id), d.item_type " +
          ...
          "ORDER BY a.item_maj_type DESC, a.pay_run_priority, a.item_code_name";
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.mnFrm.prsnitm_SQL1 = strSql;
            return dtst;
        }
        ...
        public static string concatCurRoleIDs()
        {
            ...
            int totl = Global3.mnFrm.cmCde1.Role_Set_IDs.Length;
            for (int i = 0; i < totl; i++)
            {
                nwStr = nwStr + "," + Global3.mnFrm.cmCde1.Role_Set_IDs[i].ToString();
                if (i < totl - 1)
                {
                    //nwStr = nwStr + ",";
                }
...
From org.org_pay_items Where item_id=" + pyItmID.ToString();
      ...
      From scm.scm_sales_invc_det Where invc_hdr_id=" + invcID.ToString() +
        ...
        public static double getRcptCost(string parRecNo)
        {
            ...
            DataSet Ds = Global3.fillDataSetFxn(selSQL);
            if (Ds.Tables[0].Rows.Count <= 0)
            {
                return 0.00;
            }
        ...
        public static double getTtlPaymnt(string parRcptNo, int dfltAcntPyblID)
        {
            ...
            DataSet Ds = new DataSet();
            Ds.Reset();
            Ds = Global3.fillDataSetFxn(qryGetTtlPaymnts);
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Batch Name = " + batchName;
...
to_char(to_timestamp(docs_end_date,'YYYY-MM-DD HH24:MI:SS'),'DD-Mon-YYYY HH24:MI:SS'), batch_status, 
      ...
      FROM accb.accb_payments_batches a " +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.pyblsFrm.docTmplt_SQL = strSql;
            return dtst;
        }
...
scm.scm_cstmr_suplr c where c.cust_sup_name ilike '" + searchWord.Replace("'", "''") +
        ...
        WHERE((a.org_id = " + orgID + ")" + whrcls + dteCls +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.pymntFrm.rec_SQL = strSql;
            return dtst;
        }
...
scm.scm_cstmr_suplr c where c.cust_sup_name ilike '" + searchWord.Replace("'", "''") +
       ...
       FROM accb.accb_payments a " +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.pymntFrm.recDt_SQL = strSql;
            // Global3.mnFrm.cmCde1.showSQLNoPermsn(strSql);
            return dtst;
        }
...
a.pybls_smmry_type !='7Total Payments Made' and a.pybls_smmry_type !='8Outstanding Balance')";
        ...
        where src_pybls_hdr_id = " + srcDocID +
            ...
            //Global3.mnFrm.cmCde1.showSQLNoPermsn(selSQL);
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(selSQL);
  ...
  FROM accb.accb_doc_tmplts_det a " +
        ...
        public static string getLtstRcvblsIDNoInPrfx(string prfxTxt)
        {
            ...
            string sqlStr = "select count(rcvbls_invc_hdr_id) from accb.accb_rcvbls_invc_hdr WHERE org_id=" +
              Global3.mnFrm.cmCde1.Org_id + " and rcvbls_invc_number ilike '" + prfxTxt.Replace("'", "''") + "%'";
            dtSt = Global3.mnFrm.cmCde1.selectDataNoParams(sqlStr);
            if (dtSt.Tables[0].Rows.Count > 0)
            {
        ...
        public static string getLtstInvcIDNoInPrfx(string prfxTxt)
        {
            ...
            string sqlStr = "select count(invc_hdr_id) from scm.scm_sales_invc_hdr WHERE org_id=" +
              Global3.mnFrm.cmCde1.Org_id + " and invc_number ilike '" + prfxTxt.Replace("'", "''") + "%'";
            dtSt = Global3.mnFrm.cmCde1.selectDataNoParams(sqlStr);
            if (dtSt.Tables[0].Rows.Count > 0)
            {
                return (long.Parse(dtSt.Tables[0].Rows[0][0].ToString()) + 1).ToString().PadLeft(4, '0');
   ...
   SET rcvbl_smmry_amnt = ROUND(rcvbl_smmry_amnt, 2), func_curr_amount=ROUND(func_curr_amount,2), accnt_curr_amnt=ROUND(func_curr_amount,2) " +
        ...
        {
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "Document Number = " + docNum;
            string delSQL = "DELETE FROM scm.scm_rcvbl_amnt_smmrys WHERE src_rcvbl_hdr_id = " + valLnid;
            Global3.mnFrm.cmCde1.deleteDataNoParams(delSQL);
        }
          ...
          string cstmrDocNum, string docTmpltClsftn, int currID, double amntAppld, int blcngAccntID)
        {
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd");
            ...
            //Global3.mnFrm.cmCde1.showSQLNoPermsn(insSQL);
            Global3.mnFrm.cmCde1.insertDataNoParams(insSQL);
        }
   ...
   SET rcvbl_smmry_type='" + lineType.Replace("'", "''") +
        ...
        public static void deleteRcvblsDocHdrNDet(long valLnid, string docNum)
        {
            ...
            //Global3.mnFrm.cmCde1.showSQLNoPermsn(delSQL);
            Global3.mnFrm.cmCde1.deleteDataNoParams(delSQL);
        ...
        public static string getRcvblsDocLastUpdate(long dochdrID, string docType)
        {
            ...
            return Global3.mnFrm.cmCde1.getFrmtdDB_Date_time();
        }
...
where f.rcvbls_invc_number ilike '" + searchWord.Replace("'", "''") +
        ...
        WHERE((a.org_id = " + orgID + ")" + whrcls +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.rcvblsFrm.rec_SQL = strSql;
            return dtst;
        }
...
a.rcvbl_smmry_type !='7Total Payments Made' and a.rcvbl_smmry_type !='8Outstanding Balance')";
  ...
  FROM accb.accb_rcvbl_amnt_smmrys a " +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.rcvblsFrm.recDt_SQL = strSql;
            return dtst;
        }
...
or scm.istaxwthhldng(y.code_id_behind)='1' or y.rcvbl_smmry_type='5Applied Prepayment'
      ...
      string apprvlSts, string nxtApprvl, double invcAmnt)
        {
            ...
            string updtSQL = "UPDATE accb.accb_rcvbls_invc_hdr SET " +
                  "approval_status='" + apprvlSts.Replace("'", "''") +
                  "', invoice_amount=" + invcAmnt + ", last_update_by=" + Global3.myInv.user_id +
                  ", last_update_date='" + dateStr +
                  "', next_aproval_action='" + nxtApprvl.Replace("'", "''") +
    ...
    long glBatchID)
      ...
      double amntAppld)
        ...
        {
            long srcbatchid = Global3.getBatchID(orgnlbatchname, orgid);
            string strSql = "";
            strSql = "SELECT a.batch_id " +
         "FROM accb.accb_trnsctn_batches a " +
            "WHERE (((a.src_batch_id = " + srcbatchid.ToString() +
  ...
  FROM scm.scm_pybls_amnt_smmrys a " +
      ...
      ORDER BY pybls_smmry_type ASC ";
        ...
        public static void flagDsplyDocLineInRcpt(string parPOID, string parPOLine, string parValue)
        {
            ...
            //update details
            string qryUpdatePODet = "UPDATE scm.scm_prchs_docs_det SET last_update_by = " + Global3.myInv.user_id +
                ", last_update_date = '" + dateStr +
                "', dsply_doc_line_in_rcpt = " + parValue +
                " WHERE prchs_doc_hdr_id = " + long.Parse(parPOID) +
                " AND prchs_doc_line_id = " + long.Parse(parPOLine);

            Global3.mnFrm.cmCde1.updateDataNoParams(qryUpdatePODet);
        }
        ...
        public static void updatePOHdr(string parPOID, string parRecStatus)
        {
            ...
            //update header
            string qryUpdatePOHdr = "UPDATE scm.scm_prchs_docs_hdr SET last_update_by = " + Global3.myInv.user_id +
                ", last_update_date = '" + dateStr +
                "', po_rec_status = '" + parRecStatus.Replace("'", "''") +
                "' WHERE prchs_doc_hdr_id = " + long.Parse(parPOID) +
                " AND org_id = " + Global3.mnFrm.cmCde1.Org_id;

            Global3.mnFrm.cmCde1.updateDataNoParams(qryUpdatePOHdr);
        }
      ...
      long glBatchID)
        ...
        public static string getLtstPyblsIDNoInPrfx(string prfxTxt)
        {
            ...
            string sqlStr = "select count(pybls_invc_hdr_id) from accb.accb_pybls_invc_hdr WHERE org_id=" +
              Global3.mnFrm.cmCde1.Org_id + " and pybls_invc_number ilike '" + prfxTxt.Replace("'", "''") + "%'";
            dtSt = Global3.mnFrm.cmCde1.selectDataNoParams(sqlStr);
            if (dtSt.Tables[0].Rows.Count > 0)
            {
                return (long.Parse(dtSt.Tables[0].Rows[0][0].ToString()) + 1).ToString().PadLeft(4, '0');
...
, round(a.invoice_amount-a.amnt_paid,2),
 a.approval_status 
        ...
        WHERE((a.org_id = " + orgID + ")" + whrcls + unpstdCls +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.wfnPyblsForm.rec_SQL = strSql;
            return dtst;
        }
...
a.pybls_smmry_type !='7Total Payments Made' and a.pybls_smmry_type !='8Outstanding Balance')";
  ...
  FROM accb.accb_pybls_amnt_smmrys a " +
            ...
            //MessageBox.Show(strSql);
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.wfnPyblsForm.recDt_SQL = strSql;
            return dtst;
        }
        ...
        public static double[] exctProcessSQL(string prcssSQL, long prcss_run_id, long prcss_def_id, long prcss_itm_id)
        {
            ...
            dtSt = Global3.mnFrm.cmCde1.selectDataNoParams(nwSQL);
        ...
        FROM scm.scm_process_run_inpts a " +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.wfnProdFrm.inpts_SQL = strSql;
            return dtst;
        }
 ...
 WHERE process_run_id=" + prcRunID;
            Global3.mnFrm.cmCde1.selectDataNoParams(updtSql);
        }
        ...
        (a.actual_qty*a.unit_cost_price), a.crncy_id, a.store_id, a.remarks_cmnts, c.subinv_name, a.rcpt_hdr_id, a.rcpt_line_id " +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.wfnProdFrm.outputs_SQL = strSql;
            return dtst;
        }
    ...
    FROM scm.scm_process_def_stages a, scm.scm_process_run_stages b " +
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            //Global3.wfnProdFrm.recDt_SQL = strSql;
            return dtst;
        }
...
WHERE z.process_run_id=b.process_run_id) outputs_cost  " +
      ...
      Int64 offset, int limit_size, int orgID, bool isDeftn)
        {
         ...
         " OFFSET " + (Math.Abs(offset * limit_size)).ToString();
            ...
            //Global3.wfnProdFrm.rec_SQL = strSql;
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
            return dtst;
        }
          ...
          string desc, string prcssClsfctn, bool isEnabled)
        {
            ...
            org_id) " +
                  ...
                  "', '" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(isEnabled) +
                  "', " + Global3.myInv.user_id + ", '" + dateStr +
                  "', " + Global3.myInv.user_id + ", '" + dateStr +
                  "', " + orgid + ")";
            Global3.mnFrm.cmCde1.insertDataNoParams(insSQL);
   ...
   SET process_def_name='" + prcssName.Replace("'", "''") +
                  ...
                  "', is_enabled='" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(isEnabled) +
                  "', last_update_by=" + Global3.myInv.user_id + ", last_update_date='" + dateStr +
      ...
      System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
         ...
         System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss");
            ...
            last_update_date) " +
                  ...
                  "', '" + endDte.Replace("'", "''") +
                  "', '" + prcssStatus.Replace("'", "''") +
                  "', " + prcssDefID + ", " + Global3.myInv.user_id + ", '" + dateStr +
                  "', " + Global3.myInv.user_id + ", '" + dateStr +
                  "')";
            Global3.mnFrm.cmCde1.insertDataNoParams(insSQL);
        }
   ...
   WHERE rcpt_hdr_id=" + rcptHdrID +
            ...
            DataSet dtdt = Global3.mnFrm.cmCde1.selectDataNoParams(selSQL);
...
|| ' (' || title || ') (' || local_id_no || ') ' fullname,
       ...
       WHERE(a.person_id = " + prsnID + ")";
            ...
            return Global3.mnFrm.cmCde1.selectDataNoParams(strSql);
       ...
       string ssnitNum, int noEmps, string descSrvcs, string lstSrvcs)
        {
            ...
            list_of_services) " +
                  ...
                  "', '" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(isEnbld) + "','" + brndNm.Replace("'", "''") +
                  "','" + typeOfOrg.Replace("'", "''") +
                  "','" + regNum.Replace("'", "''") +
                  "','" + dteIncp.Replace("'", "''") +
                  "','" + typeOfIncp.Replace("'", "''") +
        ...
        public static DataSet getUnlinkedPrsns(string prsnType)
        {
          ...
          FROM prs.prsn_names_nos a
          WHERE a.org_id = " + Global3.mnFrm.cmCde1.Org_id + @" 
          ...
          and a.person_id NOT IN (SELECT b.lnkd_prsn_id FROM scm.scm_cstmr_suplr b)";
            return Global3.mnFrm.cmCde1.selectDataNoParams(selSQL);
        }
      ...
      string sitedesc, string cntctPrsn, string cntctNos, string email,
                 ...
                 string other_info, bool isEnbld, string iban_number, int accCurID)
        {
            ...
            other_info, is_enabled, iban_number, accnt_cur_id) " +
                  ...
                  "', '" + other_info.Replace("'", "''") +
                  "', '" + Global3.mnFrm.cmCde1.cnvrtBoolToBitStr(isEnbld) + "', '" +
        ...
        public static void updateItemBalances(string parItemCode, double parQtyRcvd)
        {
            ...
            string qryUpdateItemBals = "UPDATE inv.inv_itm_list SET total_qty = (COALESCE(total_qty,0) + " + parQtyRcvd
                    ...
                    + "), last_update_date = '" + dateStr + "', last_update_by = " + Global3.myInv.user_id +
                    " WHERE item_code = '" + parItemCode.Replace("'", "''") + "' AND org_id = " + Global3.mnFrm.cmCde1.Org_id;

            Global3.mnFrm.cmCde1.updateDataNoParams(qryUpdateItemBals);
        }
 ...
 WHERE(a.itm_id = " + itmID + " and a.subinv_id = " + storID + @")";
        ...
        {
            long dailybalID = Global3.getCsgmtDailyBalsID(csgmtID, trnsDate);
            ...
            if (dailybalID <= 0)
            {
                double lstTotBals = Global3.getCsgmtLstTotBls(csgmtID, trnsDate);
                double lstRsvdBals = Global3.getCsgmtLstRsvdBls(csgmtID, trnsDate);
                double lstAvblBals = Global3.getCsgmtLstAvlblBls(csgmtID, trnsDate);
                Global3.createCnsgmtDailyBals(csgmtID, lstTotBals, lstRsvdBals, lstAvblBals, trnsDate);
                Global3.updtCnsgmtDailyBals(csgmtID, totQty,
            ...
            //Global3.updateItemBalances(getItmCodeFrmCnsgmntID(csgmtID), totQty);
        }
      ...
      string trnsDate, string src_trsID)
        {
            long dailybalID = Global3.getStockDailyBalsID(stockID, trnsDate);
            //Get dailybalid for accnt on this date
            //if doesn't exist get last accnt bals be4 this date
            //add new amount to it and insert record
            if (dailybalID <= 0)
            {
                double lstTotBals = Global3.getStockLstTotBls(stockID, trnsDate);
                double lstRsvdBals = Global3.getStockLstRsvdBls(stockID, trnsDate);
                double lstAvblBals = Global3.getStockLstAvlblBls(stockID, trnsDate);
                Global3.createStckDailyBals(stockID, lstTotBals, lstRsvdBals, lstAvblBals, trnsDate);
                Global3.updtStckDailyBals(stockID, totQty,
                  rsvdQty, avblQty, trnsDate, "Do", src_trsID);
            }
            else
            {
            ...
            //Global3.updateItemBalances(getItmCodeFrmStckID(stockID), totQty);
        }
      ...
      string trnsDate, string src_trsID)
        ...
        {
            Global3.mnFrm.cmCde1.DefaultPrvldgs = Global3.dfltPrvldgs;
            //Global3.mnFrm.cmCde1.Login_number = Global3.myInv.login_number;
            Global3.mnFrm.cmCde1.ModuleAdtTbl = Global3.myInv.full_audit_trail_tbl_name;
            Global3.mnFrm.cmCde1.ModuleDesc = Global3.myInv.mdl_description;
            Global3.mnFrm.cmCde1.ModuleName = Global3.myInv.name;
            //Global3.mnFrm.cmCde1.pgSqlConn = Global3.myInv.Host.globalSQLConn;
            //Global3.mnFrm.cmCde1.Role_Set_IDs = Global3.myInv.role_set_id;
            Global3.mnFrm.cmCde1.SampleRole = "Stores And Inventory Manager Administrator";
            //Global3.mnFrm.cmCde1.User_id = Global3.myInv.user_id;
            //Global3.mnFrm.cmCde1.Org_id = Global3.myInv.org_id;
            Global3.mnFrm.cmCde1.Extra_Adt_Trl_Info = "";
            Global3.myInv.user_id = Global3.mnFrm.usr_id;
            Global3.myInv.login_number = Global3.mnFrm.lgn_num;
            Global3.myInv.role_set_id = Global3.mnFrm.role_st_id;
            Global3.myInv.org_id = Global3.mnFrm.Og_id;
      ...
      ,"5", "Training Provider", "Training Provider"};
            ...
            Global3.mnFrm.cmCde1.createSysLovs(sysLovs, sysLovsDynQrys, sysLovsDesc);
            Global3.mnFrm.cmCde1.createSysLovsPssblVals(sysLovs, pssblVals);
       ...
       "12", "Shelf 3A", "Third Floor shelf A"
        ...
        ,"12", "Shelf 3C", "Third Floor shelf C"
          ...
          ,"19", "Over Receipt", "Over Receipt"};
            ...
            Global3.mnFrm.cmCde1.createSysLovs(sysLovs1, sysLovsDynQrys1, sysLovsDesc1);
            Global3.mnFrm.cmCde1.createSysLovsPssblVals(sysLovs1, pssblVals1);
        }

        public static DataSet fillDataSetFxn(string selSQL)
        {
            //Global3.mnFrm.cmCde1.showSQLNoPermsn(selSQL);
            //NpgsqlCommand selectCustomer = new NpgsqlCommand(selSQL, Global3.myInv.Host.globalSQLConn);
        ...
        public static double computeMathExprsn(string exprSn)
        {
            ...
            DataSet dtst = Global3.mnFrm.cmCde1.selectDataNoParams1(strSql);
            if (dtst.Tables.Count <= 0)
            {
                return 0;
            }
