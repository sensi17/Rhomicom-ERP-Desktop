...
using Payments.Forms;

namespace Payments.Classes
	{
	public class Payments : RhoModule
		{
		public Payments()
			{
			}
		...
		int putUnder = 2;
		String myName = "Payments";
		string myDesc = "This module helps you to manage your organization's Payments!";
		string audit_tbl_name = "pay.pay_audit_trail_tbl";
		WeifenLuo.WinFormsUI.Docking.DockContent myMainInterface = new mainForm();
		String vwroleName = "View Payments";
		Int64 usr_id = -1;
