...
{
  public class StoresAndInventoryManager //: RhoModule
  {
    public StoresAndInventoryManager()
    {
    }
   // RhoModuleHost myHost = null;
    ...
    String vwroleName = "View Inventory Manager";
    Int64 usr_id = -1;
   ...
   /* public RhoModuleHost Host
    ...
    public void loadMyRolesNMsgtyps()
    {
      ...
      //Global3.mnFrm.cmCde1.checkNAssignReqrmnts();
    }
    ...
    public void Initialize()
    {
      ...
      Global3.myInv = this;
      Global3.mnFrm = (mainForm)this.mainInterface;
    }
