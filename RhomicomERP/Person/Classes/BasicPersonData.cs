...
namespace BasicPersonData.Classes
	{
	public class BasicPersonData //: RhoModule
		{
    ...
    //RhoModuleHost myHost = null;
		...
		String vwroleName = "View Basic Person Data";
		Int64 usr_id = -1;
    ...
    //  }
		...
		public void creatWordReport()
			{
			Global.mnFrm.cmCde.exprtToWordPrsn(long.Parse(Global.mnFrm.prsnIDTextBox.Text));
			//MessageBox.Show("Not yet implemented!");
			}
