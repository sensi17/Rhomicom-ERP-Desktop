...
namespace SelfService.Classes
{
  public class SelfService
  {
    ...
    int putUnder = 1;
    String myName = "SelfService";
    string myDesc = "This module helps you to view SelfService of this Software!";
    string audit_tbl_name = "mnls.mnls_audit_trail_tbl";
    //WeifenLuo.WinFormsUI.Docking.DockContent myMainInterface = new mainForm();
    String vwroleName = "View SelfService";
    Int64 usr_id = -1;
