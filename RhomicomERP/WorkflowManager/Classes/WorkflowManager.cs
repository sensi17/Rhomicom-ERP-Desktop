...
namespace WorkflowManager.Classes
{
  class WorkflowManager
  {
    public WorkflowManager()
		...
		int putUnder = 1;
    String myName = "Workflow Manager";
    string myDesc = "This module helps you to manage your organization's Workflow!";
    string audit_tbl_name = "wkf.wkf_audit_trail_tbl";
		//WeifenLuo.WinFormsUI.Docking.DockContent myMainInterface = new mainForm();
    String vwroleName = "View Workflow Manager";
		Int64 usr_id = -1;
